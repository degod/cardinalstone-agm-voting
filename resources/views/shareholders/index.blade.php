...
<div class="container mt-5">
    <h1 class="mb-4">Shareholders Management</h1>

    <a href="#" data-bs-toggle="modal" data-bs-target="#addShareholderModal" class="btn btn-success mb-3 float-end">Add New Shareholder</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('shareholders.edit', $shareholder->id) }}" class="btn btn-primary btn-sm">Edit</a>
